...
echo "   cd grafana (Se debe configurar el archivo confgi de grafana en ./conf/grafana.ini a htt_port=9091)" 
echo "   ./bin/grafana-server web" 
echo ""
echo "🌐 Luego visita: http://localhost:9091 (usuario: admin / contraseña: admin)"
